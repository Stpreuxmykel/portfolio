...
const projects = [
  {
    ...
    category: "Full Stack",
    title: "Project 1",
    description: "I developed a robust and scalable marketplace platform using Laravel...",
    stack: [
      { name: "HTML 5" },
      { name: "Css 3" },
      { name: "JavaScript" },
  ...
  },
  {
    ...
    category: "Development of a university website",
    title: "Project 2",
    description: "Together with two other programmers, I created a university website...",
    stack: [
      { name: "HTML 5" },
      { name: "Css 3" },
      { name: "JavaScript" },
